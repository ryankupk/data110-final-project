...
```{r}
curbWeight <- c(0, 2855, 3307, 2883, 3550, 2019, 2848, 2646, 2848, 2978, 2990, 3505, 2535, 2509, 2601, 4052, 2800, 4387, 3075)
...
data.frame(makeModel[-1], engineSize[-1]) %>%
  kable() %>%
  kable_styling()
...
data.frame(makeModel[-1], numberOfCylinders[-1]) %>%
  kable() %>%
  kable_styling()
...
data.frame(makeModel[-1], turboChargers[-1]) %>%
  kable() %>%
  kable_styling()
...
data.frame(makeModel[-1], brakeHorsepower[-1]) %>%
  kable() %>%
  kable_styling()
